...
export default class HomePagePost extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      menuTop: 0,
      showPostDeleteOption: false,
      likeorUnlikeImgUri: require('../../images/unlike-icon.png'),
      postLikesCount:
        this.props.markerData.markerlike !== null
          ? this.props.markerData.markerlike.length
          : 0,
    };
  }
  ...
  componentDidMount() {
    ...
    console.debug('HomePOSTS: DID MOUNT', postDetails);
    ...
    if (postDetails.userid === userData.userid) {
      showDeleteOption = true;
    }
    this.setState({
      showPostDeleteOption: showDeleteOption,
      isMarkerAlreadyLiked: isAlreadyLiked,
      likeorUnlikeImgUri: isAlreadyLiked
  ...
  showOptions = () => {
    this.props.showMenuOptions(this.state.menuTop, this.state.postDetails);
  };
      ...
      <View style={styles.container}>
        <View
          ...
          onTouchStart={e => {
            ...
            this.setState({menuTop: e.nativeEvent.pageY - 20});
          }}>
          <TouchableOpacity
          ...
          {this.state.showPostDeleteOption ? (
            ...
            <Text
              style={[
                ...
                AppStyle.app_font,
                {
                  ...
                  marginRight: 15,
                  marginBottom:
                    postimagesAry.length === 0 || postimagesAry[0] === null
                      ? 0
                      : 15,
                },
              ]}>
